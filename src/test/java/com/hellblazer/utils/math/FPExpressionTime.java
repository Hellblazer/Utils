...
public class FPExpressionTime {
    ...
    public void run() {
        ...
        System.out.println("MutableDoubleDouble VS double performance factor = "
                           + mddTime / doubleTime);

        System.out.println("MutableDoubleDouble VS DoubleDouble performance factor = "
                           + mddTime / ddTime);
    }
    ...
    public double runMutableDoubleDouble(int nIter) {
        ...
        for (int i = 0; i < nIter; i++) {
            ...
            MutableDoubleDouble aMul = factor.multiply(new MutableDoubleDouble(
                                                                               9.0));
            MutableDoubleDouble aDiv = new MutableDoubleDouble(9.0).divide(new MutableDoubleDouble(
                                                                                                   10.0));
