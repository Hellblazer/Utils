...
public class DoubleDoubleBasicTest extends TestCase {
    ...
    public void testNaN() {
        assertTrue(DoubleDouble.valueOf(1).divide(DoubleDouble.valueOf(0)).isNaN());
    ...
    public void testTrunc() {
        checkTrunc(DoubleDouble.valueOf(1e16).subtract(DoubleDouble.valueOf(1)),
