...
package com.hellblazer.utils.fd.json;
...
public class FdFactoryModule extends SimpleModule {

    private static final long serialVersionUID = 1L;

    public FdFactoryModule() {
        super("FdFactoryModule");
    }

    public FdFactoryModule(String name) {
        super(name);
    }
