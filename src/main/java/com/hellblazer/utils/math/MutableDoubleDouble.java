 ...
 * 
 */
public strictfp class MutableDoubleDouble implements Serializable,
		Comparable<MutableDoubleDouble>, Cloneable {
	/**
	 * 
	 */
	 ...
	 */
	public static final MutableDoubleDouble PI = new MutableDoubleDouble(
			3.141592653589793116e+00, 1.224646799147353207e-16);

	/**
	 * The value nearest to the constant 2 * Pi.
	 */
	public static final MutableDoubleDouble TWO_PI = new MutableDoubleDouble(
			6.283185307179586232e+00, 2.449293598294706414e-16);

	/**
	 * The value nearest to the constant Pi / 2.
	 */
	public static final MutableDoubleDouble PI_2 = new MutableDoubleDouble(
			1.570796326794896558e+00, 6.123233995736766036e-17);

	/**
	 * The value nearest to the constant e (the natural logarithm base).
	 */
	public static final MutableDoubleDouble E = new MutableDoubleDouble(
	 ...
	 * valid number.
	 */
	public static final MutableDoubleDouble NaN = new MutableDoubleDouble(
	...
	private static final MutableDoubleDouble TEN = new MutableDoubleDouble(10.0);

	private static final MutableDoubleDouble ONE = new MutableDoubleDouble(1.0);
	 ...
	 */
	public static MutableDoubleDouble parse(String str)
		...
		// scaling later
		MutableDoubleDouble val = new MutableDoubleDouble();
		...
		while (true) {
			...
			if (Character.isDigit(ch)) {
				...
				val.selfAdd(new MutableDoubleDouble(d));
				numDigits++;
				continue;
			}
			if (ch == '.') {
		...
		if (numDecPlaces == 0) {
			...
			MutableDoubleDouble scale = TEN.pow(numDecPlaces);
	 ...
	 */
	public static MutableDoubleDouble valueOf(double x) {
		return new MutableDoubleDouble(x);
	}
	 ...
	 */
	public static MutableDoubleDouble valueOf(String str)
			throws NumberFormatException {
		return parse(str);
	}
	 ...
	 */
	public MutableDoubleDouble(double x) {
		init(x);
	}
	 ...
	 *            the high-order component
	 */
	public MutableDoubleDouble(double hi, double lo) {
		init(hi, lo);
	}
	 ...
	 *            the value to initialize
	 */
	public MutableDoubleDouble(MutableDoubleDouble dd) {
		init(dd);
	}
	 ...
	 */
	public MutableDoubleDouble(String str) throws NumberFormatException {
		this(parse(str));
	}
	 ...
	 */
	public MutableDoubleDouble abs() {
		if (isNaN())
			return NaN;
		if (isNegative())
			return negate();
		return new MutableDoubleDouble(this);
	}
	 ...
	 * @return <tt>(this + y)</tt>
	 */
	public MutableDoubleDouble add(MutableDoubleDouble y) {
		if (isNaN())
			return this;
		selfAdd(y);
		return this;
	 ...
	 */
	public MutableDoubleDouble ceil() {
		if (isNaN())
			return NaN;
		...
		return new MutableDoubleDouble(fhi, flo);
	}
	 ...
	 */
	public int compareTo(MutableDoubleDouble other) {
		if (hi < other.hi)
			return -1;
		if (hi > other.hi)
			return 1;
	 ...
	 * @return <tt>(this / y)</tt>
	 */
	public MutableDoubleDouble divide(MutableDoubleDouble y) {
	 ...
	 */
	public boolean equals(MutableDoubleDouble y) {
	...
	private String extractSignificantDigits(boolean insertDecimalPoint,
			int[] magnitude) {
		MutableDoubleDouble y = this.abs();
		// compute *correct* magnitude of y
		int mag = magnitude(y.hi);
		MutableDoubleDouble scale = TEN.pow(mag);
		y = y.divide(scale);
		...
		for (int i = 0; i <= numDigits; i++) {
			...
			y = (y.subtract(MutableDoubleDouble.valueOf(digit)).multiply(TEN));
			if (rebiasBy10)
				y.selfAdd(TEN);
	 ...
	 */
	public MutableDoubleDouble floor() {
		if (isNaN())
			return NaN;
	 ...
	 * @return true if this value >= y
	 */
	public boolean ge(MutableDoubleDouble y) {
	 ...
	 * @return true if this value > y
	 */
	public boolean gt(MutableDoubleDouble y) {
		return (hi > y.hi) || (hi == y.hi && lo > y.lo);
	}
	...
	private void init(MutableDoubleDouble dd) {
		init(dd.hi, dd.lo);
	}
	 ...
	 * @return true if this value <= y
	 */
	public boolean le(MutableDoubleDouble y) {
		return (hi < y.hi) || (hi == y.hi && lo <= y.lo);
	}
	 ...
	 * @return true if this value < y
	 */
	public boolean lt(MutableDoubleDouble y) {
		return (hi < y.hi) || (hi == y.hi && lo < y.lo);
	}
	 ...
	 * @return <tt>(this * y)</tt>
	 */
	public MutableDoubleDouble multiply(MutableDoubleDouble y) {
		if (isNaN())
			return this;
		if (y.isNaN())
			return y;
	 ...
	 * @return <tt>-this</tt>
	 */
	public MutableDoubleDouble negate() {
		if (isNaN())
			return this;
		return new MutableDoubleDouble(-hi, -lo);
	}
	 ...
	 */
	public MutableDoubleDouble pow(int exp) {
		if (exp == 0.0)
			return valueOf(1.0);

		MutableDoubleDouble r = new MutableDoubleDouble(this);
		MutableDoubleDouble s = valueOf(1.0);
		int n = Math.abs(exp);
	 ...
	 */
	public MutableDoubleDouble reciprocal() {
		double hc, tc, hy, ty, C, c, U, u;
		C = 1.0 / hi;
		c = SPLIT * C;
		hc = c - C;
		...
		double zhi = C + c;
		double zlo = (C - zhi) + c;
		return new MutableDoubleDouble(zhi, zlo);
	}
	 ...
	 */
	public MutableDoubleDouble rint() {
		if (isNaN())
			return this;
		// may not be 100% correct
		MutableDoubleDouble plus5 = this.add(new MutableDoubleDouble(0.5));
		return plus5.floor();
	}
	 ...
	 */
	private MutableDoubleDouble selfAdd(MutableDoubleDouble y) {
	 ...
	 * @return this
	 */
	private MutableDoubleDouble selfMultiply(MutableDoubleDouble y) {
	 ...
	 */
	public MutableDoubleDouble sqr() {
	 ...
	 */
	public MutableDoubleDouble sqrt() {
		/*
		...
		if (isZero())
			return new MutableDoubleDouble(0.0);
		...
		MutableDoubleDouble axdd = new MutableDoubleDouble(ax);
		MutableDoubleDouble diffSq = this.subtract(axdd.sqr());
		double d2 = diffSq.hi * (x * 0.5);

		return axdd.add(new MutableDoubleDouble(d2));
	}
	 ...
	 * @return <tt>(this - y)</tt>
	 */
	public MutableDoubleDouble subtract(MutableDoubleDouble y) {
		if (isNaN())
			return this;
		return add(y.negate());
	}
	 ...
	 */
	public MutableDoubleDouble trunc() {
		if (isNaN())
			return NaN;
		if (isPositive())
			return floor();
