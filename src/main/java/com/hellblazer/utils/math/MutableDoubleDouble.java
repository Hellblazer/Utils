...
public strictfp class MutableDoubleDouble implements Serializable,
    ...
    private static final MutableDoubleDouble TEN                   = new MutableDoubleDouble(
                                                                                             10.0);

    private static final MutableDoubleDouble ONE                   = new MutableDoubleDouble(
                                                                                             1.0);
    ...
    public MutableDoubleDouble rint() {
        ...
        MutableDoubleDouble plus5 = add(new MutableDoubleDouble(0.5));
        return plus5.floor();
    }
    ...
    public MutableDoubleDouble sqrt() {
        ...
        MutableDoubleDouble diffSq = subtract(axdd.sqr());
