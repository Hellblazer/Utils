...
public class HexDump {
    ...
    public static String hexdump(ByteBuffer src, int srcIndex, int length) {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        PrintStream ps = new PrintStream(baos);
        hexdump(ps, src, srcIndex, length);
        ps.close();
    ...
    public static void hexdump(PrintStream ps, byte[] src) {
        hexdump(ps, src, 0, src.length);
    }
    ...
    public static void hexdump(PrintStream ps, byte[] src, int srcIndex,
                               int length) {
        if (length == 0) {
            return;
        }
    ...
    public static void hexdump(PrintStream ps, ByteBuffer src) {
        hexdump(ps, src, src.position(), src.limit());
    }
    ...
    public static void hexdump(PrintStream ps, ByteBuffer src, int srcIndex,
                               int length) {
        if (length == 0) {
            return;
        }
